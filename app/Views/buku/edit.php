...
<form action="<?= base_url('buku/update/' . $buku['id_buku']) ?>" method="post" enctype="multipart/form-data">
    ...
    <div>
        ...
        <br>
        <input type="text" name="penerbit_baru" placeholder="Atau tulis penerbit baru">
    </div>

    <!-- 🔥 RAK (PILIH ATAU TULIS) -->
    <div>
        <label>Rak</label><br>
        ...
        <br>
        <input type="text" name="rak_baru" placeholder="Atau tulis rak baru ">
    </div>
